...
class NovelCommentCell extends StatelessWidget {
  ...
  Widget buildButton(String image, String title, VoidCallback onPressed, bool isSelected) {
    return Row(
      children: <Widget>[
        Image.asset(image),
        SizedBox(width: 5),
        Text(
          title,
          style: TextStyle(fontSize: 14, color: isSelected ? Color(0xfff5a023) :EColor.gray),
        )
      ],
    );
  }
