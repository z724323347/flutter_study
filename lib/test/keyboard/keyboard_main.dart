...
import 'package:flutter_book/util/toast.dart';
...
class KeyboardTestPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new KeyboardTestPageState();
  }
}

class KeyboardTestPageState extends State<KeyboardTestPage> {
  String pwdData = '';
